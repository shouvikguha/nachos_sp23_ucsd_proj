...
public class KThread {
	...
	public void join() {
		...
		Lib.assertTrue(this != currentThread);
		Lib.assertTrue(this.isJoined != true);
    ...
    public static void joinTest1 () {
		System.out.println("Running test for KThread");
	...
	public static void joinTest2() {
		...
		KThread child1 = new KThread( new Runnable () {
			public void run() {
				System.out.println("I (heart) Nachos!" + currentThread.id);
			}
		});
	...
	public static void joinTest3() {
		...
		try {
			...
			System.out.println("Encountered exception for self-join");
		}
	} 
